...
namespace UnityEngine.XR.OpenXR.Features.Interactions
{
    ...
    public class HTCViveTrackerProfile : OpenXRInteractionFeature
    {
        ...
        public static class TrackerComponentPaths
        {
            ...
            public const string systemClick = "/input/system/click";
            ...
            public const string trackpadX = "/input/trackpad/x";
            public const string trackpadY = "/input/trackpad/y";
        ...
        public class XRViveTracker : XRTracker
        {
            ...
            [Preserve, InputControl]
            public ButtonControl squeezeButton { get; private set; }
            [Preserve, InputControl]
            public ButtonControl triggerButton { get; private set; }
            [Preserve, InputControl]
            public ButtonControl trackpadButton { get; private set; }
            [Preserve, InputControl]
            public HapticControl haptics { get; private set; }
            ...
            protected override void FinishSetup()
            {
                ...
                squeezeButton = GetChildControl<ButtonControl>("squeezeButton");
                triggerButton = GetChildControl<ButtonControl>("triggerButton");
                haptics = GetChildControl<HapticControl>("haptics");
                trackpadButton = GetChildControl<ButtonControl>("trackpadButton");



                var capabilities = description.capabilities;
                var deviceDescriptor = XRDeviceDescriptor.FromJson(capabilities);
                if ((deviceDescriptor.characteristics & (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerHandheld) != 0)
                    InputSystem.InputSystem.SetDeviceUsage(this, "Handheld Object");
                else if ((deviceDescriptor.characteristics & (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerLeftFoot) != 0)
                ...
                else if ((deviceDescriptor.characteristics & (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerLeftAnkle) != 0)
                    InputSystem.InputSystem.SetDeviceUsage(this, "Left Ankle");
                else if ((deviceDescriptor.characteristics & (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerRightAnkle) != 0)
                    InputSystem.InputSystem.SetDeviceUsage(this, "Right Ankle");
        ...
        /// <summary> 	
        /// Return device layout string used for registering device in InputSystem. 	
        /// </summary> 	
        /// <returns>Device layout string.</returns> 	
        protected override string GetDeviceLayoutName()
        {
            // TODO: maybe switch back to this if needed
            // return kLayoutName;
        ...
        //"Left Foot", "Right Foot", "Left Shoulder", "Right Shoulder", "Left Elbow", "Right Elbow", "Left Knee", "Right Knee", "Left Wrist", "Right Wrist", "Left Ankle", "Right Ankle", "Waist", "Chest", "Camera", "Keyboard", "Handheld Object"
        [Flags]
        public enum InputDeviceTrackerCharacteristics : uint
        {
            ...
            TrackerHandheld = 0x1000000u,
            TrackerLeftWrist = 0x2000000u,
            TrackerRightWrist = 0x4000000u,
            TrackerLeftAnkle = 0x8000000u,
            TrackerRightAnkle = 0x10000000u,
        }
        ...
        protected override void RegisterActionMapsWithRuntime()
        {
            ActionMapConfig actionMap = new ActionMapConfig()
            {
                ...
                deviceInfos = new List<DeviceConfig>()
                {
                    ...
                    new DeviceConfig()
                    {
                        characteristics = (InputDeviceCharacteristics.TrackedDevice) | (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerLeftAnkle,
                        userPath = TrackerUserPaths.leftAnkle
                    },
                    new DeviceConfig()
                    {
                        characteristics = (InputDeviceCharacteristics.TrackedDevice) | (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerRightAnkle,
                        userPath = TrackerUserPaths.rightAnkle
                    },
                    new DeviceConfig()
                    {
                    ...
                    new DeviceConfig()
                    {
                        characteristics = (InputDeviceCharacteristics.TrackedDevice) | (InputDeviceCharacteristics)InputDeviceTrackerCharacteristics.TrackerHandheld,
                        userPath = TrackerUserPaths.handheldObject
                    }
                },
                actions = new List<ActionConfig>()
                {
                    ...
                    new ActionConfig()
                    {
                        ...
                        bindings = new List<ActionBinding>()
                        {
                            new ActionBinding()
                            {
                                interactionPath = TrackerComponentPaths.systemClick,
                                interactionProfileName = profile,
                            }
                        }
                    },
                    new ActionConfig()
                    {
                        ...
                        bindings = new List<ActionBinding>()
                        {
                            new ActionBinding()
                            {
                                interactionPath = TrackerComponentPaths.squeezeClick,
                                interactionProfileName = profile,
                            }
                        }
                    },
